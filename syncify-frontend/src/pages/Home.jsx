                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="text-center max-w-2xl mx-auto mb-12">
                        <h1 className="text-4xl font-bold mb-4">
                            Welcome to <span className="text-white">Syn</span>
                            <span className="text-yellow-300">cify</span>
                        </h1>
                        <p className="text-lg mb-8">
                            Transfer your Spotify playlists to YouTube with just
                            a few clicks. Simple, secure, and fast.
                        </p>
                    ...
                    <div className="bg-blue-900 bg-opacity-30 backdrop-blur-sm rounded-lg p-6 max-w-3xl mx-auto shadow-lg border border-white border-opacity-20">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            {[1, 2, 3, 4, 5, 6].map((num) => (
                                <div
                                    key={num}
                                    className="bg-blue-800 bg-opacity-30 rounded p-4 text-center"
                                >
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg shadow-sm hover:shadow  transition-shadow">
                            ...
                            <p className="text-gray-600 text-center">
                                Transfer playlists in under a minute with our
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg shadow-sm hover:shadow transition-shadow">
                            ...
                            <p className="text-gray-600 text-center">
                                We never store your credentials and use OAuth
                                for secure access.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg shadow-sm hover:shadow transition-shadow">
                            ...
                            <p className="text-gray-600 text-center">
                                Our smart matching ensures 98%+ accuracy when
                                finding your tracks.
                            </p>
                        </div>
                    </div>
