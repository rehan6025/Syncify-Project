...
function Transfer() {
    ...
    const spotifyConnected = useSelector(
        (state) => state.auth.spotifyConnected,
    );
    const youtubeConnected = useSelector(
        (state) => state.auth.youtubeConnected,
    );
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 ">
            <div className="p-4 max-w-7xl mx-auto">
                <h1 className="text-2xl font-bold">
                    ...
                    <span className="text-yellow-300">Playlists</span>{" "}
                </h1>
